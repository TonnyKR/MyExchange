        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Balance = table.Column<decimal>(type: "decimal(38,19)", nullable: false),
                    TotalEnrolment = table.Column<decimal>(type: "decimal(38,19)", nullable: false),
                    TotalWithdrawl = table.Column<decimal>(type: "decimal(38,19)", nullable: false),
                    TotalCurrentMargin = table.Column<decimal>(type: "decimal(38,19)", nullable: false),
                    TotalPositionsCost = table.Column<decimal>(type: "decimal(38,19)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentMargin = table.Column<decimal>(type: "decimal(38,19)", nullable: true),
                    WalletId = table.Column<int>(type: "int", nullable: false),
                    CurrencyId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
